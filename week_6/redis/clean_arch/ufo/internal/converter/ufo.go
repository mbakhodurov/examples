...
func UFOInfoToModel(info *ufo_v1.SightingInfo) model.SightingInfo {
...
func UpdateInfoToModel(info *ufo_v1.SightingUpdateInfo) model.SightingUpdateInfo {
	var observedAt *time.Time
	if info.ObservedAt != nil {
		tmp := info.ObservedAt.AsTime()
		observedAt = &tmp
...
func SightingToProto(sighting model.Sighting) *ufo_v1.Sighting {
...
func SightingInfoToProto(info model.SightingInfo) *ufo_v1.SightingInfo {
