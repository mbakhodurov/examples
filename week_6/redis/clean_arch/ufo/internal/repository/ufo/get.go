...
import (
	...
	repomodels "github.com/mbakhodurov/examples/week_6/redis/clean_arch/ufo/internal/repository/model"
...
func (r *repository) Get(ctx context.Context, uuid string) (model.Sighting, error) {
	...
	err := r.collection.FindOne(ctx, bson.M{"uuid": uuid}).Decode(&repoModel)
	if err != nil {
