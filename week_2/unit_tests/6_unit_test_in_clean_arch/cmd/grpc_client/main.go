...
import (
	...
	ufoV1 "github.com/mbakhodurov/examples/week_2/unit_tests/6_unit_test_in_clean_arch/pkg/proto/ufo/v1"
...
func GetAllSight(ctx context.Context, client ufo_v1.UFOServiceClient) ([]*ufo_v1.Sighting, error) {
...
func main() {
	...
	for {
		...
		case "3":
			sightings, err := GetAllSight(context.Background(), client)
			if err != nil {
